...
```sh
  cd my-folder
  git clone git@github.com:bohaz/hello-rails-back-end.git
```
...
Feel free to check the [issues page](https://github.com/bohaz/hello-rails-back-end/issues).
